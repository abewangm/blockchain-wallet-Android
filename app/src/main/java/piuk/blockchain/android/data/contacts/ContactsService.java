...
public class ContactsService {
     ...
     */
    @WebRequest
    Completable initContactsService(DeterministicKey metaDataHDNode, DeterministicKey sharedMetaDataHDNode) {
     ...
     */
    Observable<Contact> getContactList() {
    ...
    @WebRequest
    @RequiresAccessToken
    Observable<Contact> getContactsWithUnreadPaymentRequests() {
     ...
     */
    @WebRequest
    Completable renameContact(String contactId, String name) {
        return Completable.fromCallable(() -> {
    ...
    @WebRequest
    @RequiresAccessToken
    Observable<Contact> createInvitation(Contact myDetails, Contact recipientDetails) {
    ...
    @WebRequest
    @RequiresAccessToken
    Observable<Contact> acceptInvitation(String url) {
    ...
    @WebRequest
    @RequiresAccessToken
    Observable<Contact> readInvitationLink(String url) {
    ...
    @WebRequest
    @RequiresAccessToken
    Observable<Boolean> readInvitationSent(Contact contact) {
    ...
    @WebRequest
    @RequiresAccessToken
    Completable requestSendPayment(String mdid, PaymentRequest request) {
        return Completable.fromCallable(() -> {
    ...
    @WebRequest
    @RequiresAccessToken
    Completable requestReceivePayment(String mdid, RequestForPaymentRequest request) {
        return Completable.fromCallable(() -> {
    ...
    @WebRequest
    @RequiresAccessToken
    Completable sendPaymentRequestResponse(String mdid, PaymentRequest paymentRequest, String facilitatedTxId) {
        return Completable.fromCallable(() -> {
    ...
    @WebRequest
    @RequiresAccessToken
    Completable sendPaymentBroadcasted(String mdid, String txHash, String facilitatedTxId) {
        return Completable.fromCallable(() -> {
    ...
    @WebRequest
    @RequiresAccessToken
    Completable sendPaymentDeclinedResponse(String mdid, String fctxId) {
        return Completable.fromCallable(() -> {
    ...
    @WebRequest
    @RequiresAccessToken
    Completable sendPaymentCancelledResponse(String mdid, String fctxId) {
        return Completable.fromCallable(() -> {
     ...
     */
    @WebRequest
    Observable<String> fetchXpub(String mdid) {
    ...
    @WebRequest
    @RequiresAccessToken
    Observable<List<Message>> getMessages(boolean onlyNew) {
    ...
    @WebRequest
    @RequiresAccessToken
    Observable<Message> readMessage(String messageId) {
    ...
    @WebRequest
    @RequiresAccessToken
    Completable markMessageAsRead(String messageId, boolean markAsRead) {
        return Completable.fromCallable(() -> {
     ...
     */
    @WebRequest
    Completable deleteFacilitatedTransaction(String mdid, String fctxId) {
        return Completable.fromCallable(() -> {
