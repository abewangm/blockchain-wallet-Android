 ...
 *
 * Most of the time in RxJava, we're only concerned about the objects emitted by the Observable and
 * any errors - onCompleted isn't important. Use this class to reduce some of the boilerplate
