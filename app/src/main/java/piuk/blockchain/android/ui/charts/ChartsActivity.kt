...
class ChartsActivity : BaseMvpActivity<ChartsView, ChartsPresenter>(), ChartsView {
    ...
    private val typefaceRegular by unsafeLazy {
        TypefaceUtils.load(assets, "fonts/Montserrat-Regular.ttf")
    }
    private val typefaceLight by unsafeLazy {
        TypefaceUtils.load(assets, "fonts/Montserrat-Light.ttf")
    }
